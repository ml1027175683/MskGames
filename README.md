...
| 色块库存 | 相同 RGB 按数量叠放，可查看等级和数量 |
| 画作库存 | Steam 风格库存页，卡片只展示作品信息和鉴定状态 |
...
| 唯一性 | 相同像素矩阵不能重复鉴定 |
| 删除规则 | 用户新建未鉴定草稿可删除并返还色块；内置作品和已鉴定作品不可删除 |
